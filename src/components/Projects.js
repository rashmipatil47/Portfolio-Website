...
const categories = ['all', 'ai', 'backend', 'ml', 'frontend'];
...
// github: null  → button not rendered
// Live Demo button removed entirely
      ...
      <div className="container">
        <div className="section-header">
          ...
          <p className="section-subtitle">
            Production-grade AI systems, backend platforms and full stack applications.
          </p>
        </div>
