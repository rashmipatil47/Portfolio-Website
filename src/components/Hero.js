  ...
  return (
    <section id="home" className="hero">
      <div className="hero-orbs">
        <div className="orb orb-purple" style={{ width: '600px', height: '600px', top: '-150px', right: '-100px' }} />
        <div className="orb orb-blue" style={{ width: '400px', height: '400px', bottom: '0', left: '-100px' }} />
      </div>
      ...
      <div className="container hero-container">
        <div className="hero-content">
          ...
          <h1 className="hero-title">
            ...
            <span className="hero-name">{personalInfo.nameShort}</span>
          </h1>
        ...
        <div className="hero-visual">
          <div className="avatar-wrapper">
            ...
            <div className="floating-badge badge-gpa">⭐ GPA 4.0</div>
          </div>
        </div>
      </div>
